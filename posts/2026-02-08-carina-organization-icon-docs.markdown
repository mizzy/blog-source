...
ChatGPTにお願いしてアイコンをつくってもらった。りゅうこつ座（Carina）の船の竜骨と、カノープスをイメージしたデザイン。カノープスはりゅうこつ座のα星で、シリウスに次いで全天で2番目に明るい恒星。ただ、日本では南の空の低い位置にしか見えないのでマイナーな印象がある。organizationのアバターと、リポジトリのREADMEのヘッダーにも使っている。
