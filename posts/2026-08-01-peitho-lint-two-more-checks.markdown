...
閾値の24ptは固定で、frontmatterで変えられるようにはしていない。24ptという数字自体は、発表スライドの本文の下限としてよく言われる値を採っただけで、厳密な根拠があるわけではない。18ptで十分という人もいれば、会場が大きいなら30pt以上と言う人もいる。必要になったらfrontmatterのキーを足せばいいので、今は設定を増やさない側に倒している。
