...
だけどこれは的を外している。まず、2010年3月の自分の記事を読み返すと、実際には「開発と運用」ではなく「開発者と運用者」という言葉で紹介していた。そしてそもそも、訳は関係ない。この誤解の中身は、冒頭のポストにあった「開発の時系列上の役割と、技術レイヤーの話が混ざっている」という混同で、つくる・動かし続けるという時系列上の役割で分かれていた部門の話だったDevとOpsが、アプリケーションとインフラという技術レイヤーの話として受け取られてしまう、というもの。だけどこれは英語圏でも起きていて、DevOpsエンジニアという職種が実質的にインフラ担当を指すのは、英語圏でも変わらない。Allspaw氏が2010年に否定して見せた受け取られ方も、『Effective DevOps』が列挙した誤解も、すべて訳が介在しない英語圏での話だ。
