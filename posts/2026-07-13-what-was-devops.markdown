...
だけどこれは的を外している。まず、2010年3月の自分の記事を読み返すと、実際には「開発と運用」ではなく「開発者と運用者」という言葉で紹介していた。そしてそもそも、訳は関係ない。Allspaw氏が2010年に否定して見せた受け取られ方も、『Effective DevOps』が列挙した誤解も、DevとOps以外が排除されているように見えるという表記の問題も、すべて訳が介在しない英語圏での話なのだから。
